...
class Show(Models):
    ...
    plot = Column(Unicode, nullable=False)
    genre = Column(Unicode, nullable=False)
    premiered = Column(Date, nullable=False)
    studio = Column(Unicode, nullable=False)
...
class Episode(Models):
    ...
    aired = Column(Date, nullable=False)
    plot = Column(Unicode, nullable=False)
    thumb = Column(Unicode, nullable=False)
